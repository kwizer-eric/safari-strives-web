...
const items = [
  ...
  { label: "New application", href: "/applicant/apply", icon: FilePlus },
  { label: "Programs", href: "/applicant/programs", icon: BookOpen },
  { label: "Profile", href: "/applicant/profile", icon: UserIcon },
];
...
export default function AppLayout({
  ...
  return (
    <RequireRole roles={["applicant"]} loginPath="/applicant/login">
