export const home = {
  hero: {
    ...
    body: "Safari Strives provides local entrepreneurs with the tools, space, funding, and operator-led support they need to increase revenue, strengthen their businesses, create jobs, and become better positioned for future opportunities.",
    image:
